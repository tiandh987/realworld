...
const OperationRealWorldFollerUser = "/realworld.v1.RealWorld/FollerUser"
...
const OperationRealWorldUnfollerUser = "/realworld.v1.RealWorld/UnfollerUser"
...
func RegisterRealWorldHTTPServer(s *http.Server, srv RealWorldHTTPServer) {
	...
	r.POST("/api/profiles/{username}/follow", _RealWorld_FollerUser0_HTTP_Handler(srv))
	r.DELETE("/api/profiles/{username}/follow", _RealWorld_UnfollerUser0_HTTP_Handler(srv))
...
func _RealWorld_FollerUser0_HTTP_Handler(srv RealWorldHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in FollerUserRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		if err := ctx.BindVars(&in); err != nil {
		...
		http.SetOperation(ctx, OperationRealWorldFollerUser)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.FollerUser(ctx, req.(*FollerUserRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
func _RealWorld_UnfollerUser0_HTTP_Handler(srv RealWorldHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in UnfollerUserRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		if err := ctx.BindVars(&in); err != nil {
		...
		http.SetOperation(ctx, OperationRealWorldUnfollerUser)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.UnfollerUser(ctx, req.(*UnfollerUserRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
type RealWorldHTTPClient interface {
	...
	FollerUser(ctx context.Context, req *FollerUserRequest, opts ...http.CallOption) (rsp *ProfileReply, err error)
	...
	UnfollerUser(ctx context.Context, req *UnfollerUserRequest, opts ...http.CallOption) (rsp *ProfileReply, err error)
...
func (c *RealWorldHTTPClientImpl) FollerUser(ctx context.Context, in *FollerUserRequest, opts ...http.CallOption) (*ProfileReply, error) {
	var out ProfileReply
	pattern := "/api/profiles/{username}/follow"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationRealWorldFollerUser))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *RealWorldHTTPClientImpl) UnfollerUser(ctx context.Context, in *UnfollerUserRequest, opts ...http.CallOption) (*ProfileReply, error) {
	var out ProfileReply
	pattern := "/api/profiles/{username}/follow"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationRealWorldUnfollerUser))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "DELETE", path, nil, &out, opts...)
	if err != nil {
		return nil, err
