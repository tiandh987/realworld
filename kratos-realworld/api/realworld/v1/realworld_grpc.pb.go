...
type RealWorldClient interface {
	...
	FollerUser(ctx context.Context, in *FollerUserRequest, opts ...grpc.CallOption) (*ProfileReply, error)
	UnfollerUser(ctx context.Context, in *UnfollerUserRequest, opts ...grpc.CallOption) (*ProfileReply, error)
...
func (c *realWorldClient) FollerUser(ctx context.Context, in *FollerUserRequest, opts ...grpc.CallOption) (*ProfileReply, error) {
	out := new(ProfileReply)
	err := c.cc.Invoke(ctx, "/realworld.v1.RealWorld/FollerUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *realWorldClient) UnfollerUser(ctx context.Context, in *UnfollerUserRequest, opts ...grpc.CallOption) (*ProfileReply, error) {
	out := new(ProfileReply)
	err := c.cc.Invoke(ctx, "/realworld.v1.RealWorld/UnfollerUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RealWorldServer interface {
	...
	FollerUser(context.Context, *FollerUserRequest) (*ProfileReply, error)
	UnfollerUser(context.Context, *UnfollerUserRequest) (*ProfileReply, error)
...
func (UnimplementedRealWorldServer) FollerUser(context.Context, *FollerUserRequest) (*ProfileReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FollerUser not implemented")
}
func (UnimplementedRealWorldServer) UnfollerUser(context.Context, *UnfollerUserRequest) (*ProfileReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnfollerUser not implemented")
}
...
func _RealWorld_FollerUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FollerUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RealWorldServer).FollerUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/realworld.v1.RealWorld/FollerUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RealWorldServer).FollerUser(ctx, req.(*FollerUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RealWorld_UnfollerUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UnfollerUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RealWorldServer).UnfollerUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/realworld.v1.RealWorld/UnfollerUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RealWorldServer).UnfollerUser(ctx, req.(*UnfollerUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RealWorld_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FollerUser",
			Handler:    _RealWorld_FollerUser_Handler,
		},
		{
			MethodName: "UnfollerUser",
			Handler:    _RealWorld_UnfollerUser_Handler,
		},
		{
